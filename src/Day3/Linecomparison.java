...
public class Linecomparison {
    ...
    static void LengthOfLine() {
        ...
        System.out.println("Length of the given Line is : " + len);
    
    }
    static void EqualityOf2Line() {
    	Scanner sc = new Scanner(System.in);
        ...
        System.out.println("Length of the first Line is : " + len1);
        System.out.println("Length of the second Line is : " + len2);
		  System.out.println();
         if(len1.equals(len2))
    ...
    static void Compare2Length() {
      ...
      int y4 = sc.nextInt();
      Double len2 = Math.sqrt((x4 - x3) * (x4 - x3)  +  (y4 - y3) * (y4 - y3));
      System.out.println("Length of the first Line1 is : " + len1 );
      System.out.println("Length of the second Line2 is : " + len2 );
		  System.out.println();
